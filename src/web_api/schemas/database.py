...
class TranscriptionEvaluationModel(BaseModel):
    id: str
    manager: str
    assistant: str
    filename: str
...
database_schema = {
    "Transcription Evaluation Table": TranscriptionEvaluationModel.model_json_schema(),
    "Transcription Table": TranscriptionModel.model_json_schema()
}
